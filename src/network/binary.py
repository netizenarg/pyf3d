...
class MessageType(IntEnum):
    ...
    PLAYER_ROTATION = 307
    PLAYER_POSITION = 308
    PLAYER_POSITION_CORRECTION = 309
    PLAYERS_UPDATE = 350

    ENTITY_SPAWN = 400
    ENTITY_UPDATE = 401
    ENTITY_DESPAWN = 402
    ENTITY_BATCH_UPDATE = 403
...
class NetworkHeader:
    ...
    def __init__(self, message_type: int = 0, sequence: int = 0,
                 version: int = CURRENT_PROTOCOL_VERSION, flags: int = 0):
